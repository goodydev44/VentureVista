  ...
  return (
    <div className="grid grid-cols-3 gap-2 mt-28">
      ...
      <div className="relative">
        <img src={img1} className="h-[350px] w-full brightness-[.8]" alt="" />
      ...
      <div className="relative">
        <img src={img2} className="h-[350px] w-full brightness-[.8]" alt="" />
        <div className="absolute text-white bottom-11 left-10">
      ...
      <div className="relative">
        <img src={img3} className="h-[350px] w-full brightness-[.8]" alt="" />
        <div className="absolute text-white bottom-11 left-10">
      ...
      <div className="relative">
        <img src={img4} className="h-[350px] w-full brightness-[.8]" alt="" />
        <div className="absolute text-white bottom-11 left-10">
      ...
      <div className="flex flex-col justify-center bg-gradient-to-tl from-[#e38022] to-[#eebd2f] text-white px-36 row-span-2">
        <p className="font-medium text-lg leading-[1.5rem]">Wanna travel to the most thrilling spot on the planet? We've set a bumch of surprises for you.</p>
        <div>
      ...
      <div className="relative">
        <img src={img5} className="h-[350px] w-full brightness-[.8]" alt="" />
        <div className="absolute text-white bottom-11 left-10">
      ...
      <div className="relative">
        <img src={img6} className="h-[350px] w-full brightness-[.8]" alt="" />
        <div className="absolute text-white bottom-11 left-10">
