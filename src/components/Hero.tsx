...
const Hero: React.FC = () => {
  return (
    <div className="relative py-20 bg-center bg-no-repeat bg-cover"
      style={{ backgroundImage: `url(${Img})` }}>
      <div className="w-[30rem] bg-black/50 backdrop-blur-[3px] px-12 py-6">
        ...
        <div className="grid grid-cols-2 gap-7 text-white mt-12">
          <div>
